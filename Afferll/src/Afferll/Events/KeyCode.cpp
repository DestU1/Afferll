...
namespace Afferll
{
	...
	std::string AFRL_API ToString(KeyCode _Val)
	{
		static const std::unordered_map<KeyCode, std::string> keyMap({
			...
			{ KeyCode::NumPadAdd,      std::string("Num Pad Add")      },
			{ KeyCode::NumPadSubtract, std::string("Num Pad Subtract") },
			{ KeyCode::NumPadDecimal,  std::string("Num Pad Decimal")  },
			...
			{ KeyCode::Equal,        std::string("Equal")         },
			{ KeyCode::LeftBracket,  std::string("Left Bracket")  },
			{ KeyCode::RightBracket, std::string("Right Bracket") },
			{ KeyCode::Backslash,    std::string("Backslash")     },
			{ KeyCode::Semicolon,    std::string("Semicolon")     },
